...
<div class="container">
<div class="col-sm-8 autto upore">


  
   <form action="adminpanel.php" method="POST">
   <label for="ta">Name</label>
   <input type="text" name="name" class="form-control rb" required><br><br>
   <label for="ta">Email</label>
   <input type="text" name="email" class="form-control rb" required><br><br>
   <label for="ta">Status</label>
   <select name="status" class="form-control rb">
