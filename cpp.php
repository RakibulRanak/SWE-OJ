...
$limit=$r4['tlimit'];
	...
	else
	{
		...
		echo "<div class=\"row\"><div class=\"col-sm-3\"></div><div class=\"col-sm-12\"><div class=\"alert alert-danger\"><strong>Compilation Error Or Submit Failed!</strong> Back To Problem Description And Submit Code Again.</div></div><div class=\"col-sm-2\"></div></div><br>";
	}
